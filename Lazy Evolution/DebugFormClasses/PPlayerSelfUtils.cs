...
namespace LazyEvo.Debug
{
    internal class PPlayerSelfUtils : PPlayerSelf
    {
        ...
        public List<NameValuePair> GetNameValuePairs()
        {
            ...
            nvList.Add(new NameValuePair("SubZoneText", SubZoneText.ToString()));
            nvList.Add(new NameValuePair("ZoneText", ZoneText.ToString()));
            ...
            nvList.Add(new NameValuePair("BagSlotFlags", BagSlotFlags.ToString()));
            return nvList;
        }
    }
}