namespace LazyEvo.PVEBehavior.Behavior.Conditions
{
    ...
    internal class ChiCondition : AbstractCondition
    {
        ...
        public override bool IsOk
        {
            get
            {
                ...
                {
                    return (LazyLib.Wow.ObjectManager.MyPlayer.Chi == this.Value);
                }
                if (this.Condition.Equals(ConditionEnum.LessThan))
                {
                    return (LazyLib.Wow.ObjectManager.MyPlayer.Chi < this.Value);
                }
                return (this.Condition.Equals(ConditionEnum.MoreThan) && (LazyLib.Wow.ObjectManager.MyPlayer.Chi >= this.Value));
            }
        }
